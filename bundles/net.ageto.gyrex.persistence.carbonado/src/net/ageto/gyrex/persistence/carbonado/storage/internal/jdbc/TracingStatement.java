...
public class TracingStatement<T extends Statement> implements Statement {
	...
	public static final String TIMER_FETCH = "fetch";
	...
	public ResultSet executeQuery(final String sql) throws SQLException {
		...
		final TimerMetric rsMetric = getMetricForFetch();
		if (rsMetric == null)
			return rs;
	...
	protected TimerMetric getMetricForFetch() {
		if ((tracingContext == null) || !tracingContext.isEnabled())
			return null;
		return tracingContext.getTimer(TIMER_FETCH);
	}
	...
	public ResultSet getResultSet() throws SQLException {
		final TimerMetric metric = getMetricForFetch();
		if (metric == null)
	...
	private ResultSet tracingResultSet(final ResultSet rs, final TimerMetric metric) {
